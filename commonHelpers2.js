...
</li>`).join("")}e.container.insertAdjacentHTML("afterbegin",t(i));if(o.length){const a=o.reduce((s,{qty:n})=>s+n,0);e.totalQuantity.textContent=a,e.container.insertAdjacentHTML("afterbegin",t(o)),e.clearBtn.addEventListener(click,u)}function u(){localStorage.removeItem(l)}t(i);
