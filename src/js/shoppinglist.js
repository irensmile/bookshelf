...
//     },
    ...
    //   "article_chapter_link": "",
    //   "author": "Anna Lembke",
    //   "book_image": "https://storage.googleapis.com/du-prd/books/images/9781524746728.jpg",
    ...
    //   "date": "2023-04-07T08:46:57.000Z",
    //   "age_group": "",
    //   "amazon_product_url": "http://www.amazon.com/The-Glass-Castle-A-Memoir/dp/074324754X?tag=NYTBSREV-20",
    //   "article_chapter_link": "",
    //   "author": "Jeannette Walls",
    //   "book_image": "https://storage.googleapis.com/du-prd/books/images/9780743247542.jpg",
    ...
    //   "date": "2023-04-07T08:46:57.000Z",
    //   "age_group": "",
    //   "amazon_product_url": "http://www.amazon.com/Just-Mercy-Story-Justice-Redemption-ebook/dp/B00JYWVYLY?tag=NYTBSREV-20",
    //   "article_chapter_link": "",
    ...
    //   "contributor_note": "",
    //   "created_date": "2023-04-05 22:05:28",
    //   "description": "A collection of personal essays that review different facets of the human-centered planet.",
    //   "first_chapter_link": "",
    //   "price": "0.00",
...
function createMarkup(arr) {
  return arr.map(({id, book_image, title, list_name, description, author})=> `
<li data-id='${id}' class='card-item'>
   ...
   <li>
     ...
     >
       <svg class="" width="16" height="16">
         <use href="./images/icons.svg#icon-book-icon"></use>
       </svg>
     </a>
 </li>
</ul>
...
if (books.length){
  ...
  elements.clearBtn.addEventListener(click, handlerClearBasket)
    ...
    elements.container.textContent = 'This page is empty, add some books and proceed to order.'
  }


  function handlerClearBasket() {
    localStorage.removeItem(BOOKS_KEY);
    elements.booksImg.display = 'flex';
  }
